            ...
            <div class="card-body">
                <form class="editForm" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" rows="3" required name="description">{{ $data->description }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="price">Price</label>
                        <input type="number" class="form-control" id="price" step="0.01" required name="price"
                            value="{{ $data->price }}">
                    </div>
